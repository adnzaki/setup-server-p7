...
BACKUP_DIR="/var/backups/sisauang"
TIMESTAMP=$(date +"%Y-%m-%d_%H-%M")
FILENAME="db_sisauang_${TIMESTAMP}.sql"
...
mega-mkdir "/sisauang/database/${DATE_FOLDER}"

# Upload ke MEGA
mega-put "$BACKUP_DIR/$ZIPFILE" "/sisauang/database/${DATE_FOLDER}"
